...
public class DigitDetector {
    ...
    private final NeuralNet neuralNet = new NeuralNet(StandardCostFunction.CROSS_ENTROPY, StandardActivationFunction.RELU, StandardActivationFunction.SOFTMAX, 784, 256, 128, 10);
